...
push_other_images() {
	for version in "10.2-bionic" "10.2.${version_10_2_patch}" "10.2"; do
	...
	for version in "10.3-bionic" "10.3.${version_10_3_patch}" "10.3"; do
		local image="creemama/mariadb-aws_key_management-plugin-build:${version}"
		docker tag \
	...
	for version in "10.4-bionic" "10-bionic" "bionic" "10.4.${version_10_4_patch}" "10.4" "10" "latest"; do
		local image="creemama/mariadb-aws_key_management-plugin-build:${version}"
		docker tag \
